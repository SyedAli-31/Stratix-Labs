...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen bg-background text-foreground py-16 mt-20 px-6 md:px-12">
      <div className="bg-card backdrop-blur-xl bg-opacity-30 rounded-lg shadow-lg p-8 border border-border font-sans">
        <h1 className="text-3xl md:text-5xl font-extrabold text-center text-yellow-700  mb-6 leading-tight">
