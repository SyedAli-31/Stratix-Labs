...
const navLinks: NavLink[] = [
  ...
  { name: "About", href: "/about" },
  {
    ...
    subLinks: [
      ...
      { name: "More", href: "/services#other-services" },
    ],
  },
  ...
  return (
    ...
    >
      <div className="container mx-auto px-3">
        ...
        {/* Main Nav */}
        <div className="flex items-center justify-between py-3 ml-4 relative">
          {/* Logo */}
            ...
            {navLinks.map((link) => (
              <div key={link.name} className="relative group">
                {link.subLinks ? (
                  <>
                    <button
                      className="flex items-center gap-1 px-3 py-2 text-sm font-medium text-black transition-all duration-300 bg-white rounded-md group-hover:bg-blue-600 group-hover:text-white"
                    ...
                    <AnimatePresence>
                      {isServicesOpen && (
                        <motion.div
                          ...
                          onMouseEnter={() => setIsServicesOpen(true)}
                          onMouseLeave={() => setIsServicesOpen(false)}
                          className="absolute left-0 mt-2 w-48 bg-white border border-black rounded-md shadow-lg z-50 overflow-hidden"
                        >
